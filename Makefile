...
runtime.o: bindings.c
	gcc -g -c -I php-src/Zend -I php-src -I php-src/TSRM -I php-src/main -I ocaml -I ocaml/byterun -I ocaml/asmrun php-src/Zend/*.o ocaml/byterun/*.o -o runtime.o bindings.c -lm -ldl -lncurses
...
llvm_test_compile: llvm_test runtime.o
	./llvm_test
	llvm-dis-3.6 llvm_test.bc
	llc-3.6 llvm_test.bc
	clang-3.6 -c llvm_test.s -O3
	clang-3.6 -I php-src/Zend -o test php-src/Zend/*.o ocaml/byterun/*.o runtime.o llvm_test.o -O3 -lm -ldl -lncurses
